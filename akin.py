...
class PhraseBasedSMT:
    ...
    def word_alignment(self):
        ...
        subprocess.call("/mnt/c/smt/pbsmt/giza-pp/GIZA++-v2/GIZA++ -S corpus_fil.vcb -T corpus_eng.vcb -C corpus_fil_corpus_eng.snt -CoocurrenceFile cooc.cooc -outputpath /mnt/c/smt/pbsmt/myout", shell=True)
