...
if (defined($_EXTRACT_COMMAND)) {
  $PHRASE_EXTRACT = "/mnt/c/smt/smt/mosesdecoder/tools/bin/$_EXTRACT_COMMAND";
}
else {
  $PHRASE_EXTRACT = "/mnt/c/smt/smt/mosesdecoder/tools/bin/extract";
}
...
my $RULE_EXTRACT;
if (defined($_EXTRACT_COMMAND)) {
  $RULE_EXTRACT = "/mnt/c/smt/smt/mosesdecoder/tools/bin/$_EXTRACT_COMMAND";
}
elsif (defined($_GHKM)) {
$RULE_EXTRACT = "/mnt/c/smt/smt/mosesdecoder/tools/bin/extract-ghkm";
}
else {
  $RULE_EXTRACT = "/mnt/c/smt/smt/mosesdecoder/tools/bin/extract-rules";
}
...
my $LEXICAL_REO_SCORER = "/mnt/c/smt/smt/mosesdecoder/tools/bin/lexical-reordering-score";
my $MEMSCORE = "$SCRIPTS_ROOTDIR/../bin/memscore";
my $EPPEX = "$SCRIPTS_ROOTDIR/../bin/eppex";
my $SYMAL = "/mnt/c/smt/smt/mosesdecoder/tools/bin/symal";
my $GIZA2BAL = "$SCRIPTS_ROOTDIR/training/giza2bal.pl";

my $PHRASE_SCORE;
if (defined($_SCORE_COMMAND)) {
  $PHRASE_SCORE = "/mnt/c/smt/smt/mosesdecoder/tools/bin/$_SCORE_COMMAND";
} else {
  $PHRASE_SCORE = "/mnt/c/smt/smt/mosesdecoder/tools/bin/score";
}
...
my $PHRASE_CONSOLIDATE = "/mnt/c/smt/smt/mosesdecoder/tools/bin/consolidate";
